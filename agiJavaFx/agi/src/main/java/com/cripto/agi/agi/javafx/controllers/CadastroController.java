...
public class CadastroController {
    ...
    public void esqueceuSenha(ActionEvent actionEvent) throws IOException {
        ...
        esqueceuSenhaController.setClienteController(this.controller, this.carteiraDAO, this.carteiraCriptoController, this.assinaturaController, this.assinaturaDAO);
